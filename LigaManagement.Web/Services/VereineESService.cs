...
{
    public class VereineESService : IVereineESService

    {
        private readonly HttpClient httpClient;

        public VereineESService(HttpClient httpClient)
        {
        ...
        {
            return await httpClient.PostJsonAsync<VereinAUS>("api/vereineES", newVerein);
        }
        ...
        {
            return await httpClient.PutJsonAsync<VereinAUS>("api/vereineES", updatedVerein);
        }
