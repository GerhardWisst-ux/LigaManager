...
namespace LigaManagerManagement.Web.Services
{
    public class TabelleService : ITabelleService
    {
        ...
        public Task<IEnumerable<Tabelle>> BerechneTabelleBE(ISpieltageBEService spieltagTUService, bool bAbgeschlossen, IEnumerable<VereinAUS> vereineAus, int count, string currentSaison, int ligaID, int v)
        {
            throw new NotImplementedException();
        }
    }
