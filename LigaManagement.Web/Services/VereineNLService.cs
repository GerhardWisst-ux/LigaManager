...
{
    public class VereineNLService : IVereineNLService

    {
        private readonly HttpClient httpClient;

        public VereineNLService(HttpClient httpClient)
        {
        ...
        {
            return await httpClient.PostJsonAsync<VereinAUS>("api/vereineNL", newVerein);
        }
        ...
        {
            return await httpClient.PutJsonAsync<VereinAUS>("api/vereineNL", updatedVerein);
        }
