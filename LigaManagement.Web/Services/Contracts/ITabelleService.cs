...
namespace LigaManagement.Web.Services.Contracts
{
    public interface ITabelleService
    {
        ...
        Task<IEnumerable<Tabelle>> BerechneTabelleEwig(ISpieltagService spieltagService, bool Abgeschlossen,  IEnumerable<Verein> vereine, int currentspieltag, string currentSaison, int ewigeTabelle);
