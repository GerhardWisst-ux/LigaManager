...
{
    public class VereinePTService : IVereinePTService

    {
        private readonly HttpClient httpClient;

        public VereinePTService(HttpClient httpClient)
        {
        ...
        {
            return await httpClient.PostJsonAsync<VereinAUS>("api/vereinePT", newVerein);
        }
        ...
        {
            return await httpClient.PutJsonAsync<VereinAUS>("api/vereinePT", updatedVerein);
        }
