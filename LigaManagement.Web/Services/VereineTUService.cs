...
{
    public class VereineTUService : IVereineTUService

    {
        private readonly HttpClient httpClient;

        public VereineTUService(HttpClient httpClient)
        {
        ...
        {
            return await httpClient.PostJsonAsync<VereinAUS>("api/vereineTU", newVerein);
        }
        ...
        {
            return await httpClient.PutJsonAsync<VereinAUS>("api/vereineTU", updatedVerein);
        }
