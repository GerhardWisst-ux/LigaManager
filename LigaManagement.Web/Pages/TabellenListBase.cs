...
<<<<<<< HEAD
                    if ((Convert.ToInt32(Globals.currentSaison.Substring(0, 4)) > 2022))
                        ...
                        iSpieltage = 34;
                    else if ((Convert.ToInt32(Globals.currentSaison.Substring(0, 4)) > 2010))
                        iSpieltage = 30;
                    else
                        iSpieltage = 34;
                }
...
<<<<<<< HEAD
            ...
            else if (Globals.LigaID == 14)
            {
                if ((Convert.ToInt32(Globals.currentSaison.Substring(0, 4)) > 2020) || (Convert.ToInt32(Globals.currentSaison.Substring(0, 4)) < 2023))
                    iSpieltag = 34;
                else if ((Convert.ToInt32(Globals.currentSaison.Substring(0, 4)) > 2010) || (Convert.ToInt32(Globals.currentSaison.Substring(0, 4)) < 2023))
                    iSpieltag = 34;
                else
                    iSpieltag = 30;
            }
...
<<<<<<< HEAD
                    ...
                    Tabellen = await TabelleService.BerechneTabelleBE(SpieltagBEService, bAbgeschlossen, VereineAus, currentspieltag, Globals.currentSaison, Globals.LigaID, (int)Globals.Tabart.Auswärts);
                else if (TabArt == 4)
                    Tabellen = await TabelleService.BerechneTabelleBE(SpieltagBEService, bAbgeschlossen, VereineAus, 19, Globals.currentSaison, Globals.LigaID, (int)Globals.Tabart.Vorrunde);
                else if (TabArt == 5)
                    Tabellen = await TabelleService.BerechneTabelleBE(SpieltagBEService, bAbgeschlossen, VereineAus, currentspieltag, Globals.currentSaison, Globals.LigaID, (int)Globals.Tabart.Rückrunde);
