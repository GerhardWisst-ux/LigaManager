        ...
        public async Task<IEnumerable<VereinAktSaison>> GetVereineEMWM()
        {
            ...
            try
            {
                ...
                SqlCommand command = new SqlCommand("SELECT DISTINCT [Id],[MannschaftNr],[MannschaftName1],[MannschaftName2],[Erfolge],[Gegruendet],[Hyperlink],[LandID],[GroupID2024]," +
                    ...
                    "[GroupID1998],[GroupID1996],[GroupID1994],[GroupID1992],[GroupID1990],[GroupID1988], [GroupID1986],[GroupID1984],[GroupID1982], [GroupID1980],[GroupID1978],[GroupID1974]," +
                    "[GroupID1974], [GroupID1970], [GroupID1966], [GroupID1962],[GroupID1958],[GroupID1954],[GroupID1950],[GroupID1938],[GroupID1934],[GroupID1930]  FROM [LigaDB].[dbo].[MannschaftEMWM]", conn);
                VereinAktSaison verein = null;
                List<VereinAktSaison> vereinelist = new List<VereinAktSaison>();
                using (SqlDataReader reader = command.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        //verein.GroupID1976 = int.Parse(reader["GroupID1976"].ToString());
                        verein.GroupID1974 = int.Parse(reader["GroupID1974"].ToString());
                        //verein.GroupID1972 = int.Parse(reader["GroupID1976"].ToString());
