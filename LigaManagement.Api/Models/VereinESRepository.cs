...
{
    public class VereinESRepository : IVereineESRepository
    {
        ...
        public async Task<VereinAUS> AddVerein(VereinAUS verein)
        {
            ...
            try
            {
                ...
                cmd.Connection = conn;
                cmd.CommandText = "INSERT INTO [VereineES] (VereinNr,Vereinsname1,Vereinsname2,Stadion,Fassungsvermoegen,Erfolge,Gegruendet,Pokal,Liga1,Liga2,Hyperlink)" +
        ...
        public async Task<VereinAUS> DeleteVerein(int vereinId)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = conn;
            cmd.CommandText = "DELETE FROM [dbo].[VereineES] Where Id= @Id";
        ...
        public async Task<VereinAUS> GetVerein(int vereinnr)
        {
            try
            {
                ...
                SqlCommand command = new SqlCommand("SELECT * FROM [VereineES] Where VereinNr =" + vereinnr, conn);
        ...
        public async Task<IEnumerable<VereinAUS>> GetVereine()
        {
            try
            {
                ...
                SqlCommand command = new SqlCommand("SELECT * FROM [VereineES]", conn);
                VereinAUS verein = null;
