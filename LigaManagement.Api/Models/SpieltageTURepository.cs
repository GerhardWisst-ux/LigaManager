...
{
    public class SpieltageTURepository : ISpieltageTURepository
    {
        public async Task<Spieltag> AddSpieltag(Spieltag spieltag)
        {
            try
            {
                ...
                cmd.Connection = conn;
                cmd.CommandText = "INSERT INTO SpieltageTU ([SpieltagNr],[Saison],[SaisonID],[LigaID],[Verein1_Nr],[Verein1],[Verein2_Nr],[Verein2],[Tore1_Nr],[Tore2_Nr],[Datum],[Ort],[Schiedrichter],[Abgeschlossen],[Zuschauer])" +
        ...
        public int AktSpieltag(int SaisonID)
        {
            ...
            SqlCommand command = new SqlCommand("SELECT Max([SpieltagNr] +0) AS MAXSPIELTAG FROM [SpieltageTU] WHERE Datum<GETDATE() and SaisonID = '" + SaisonID + "'", conn);
        ...
        public async Task<Spieltag> UpdateSpieltag(Spieltag spieltag)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "UPDATE [dbo].[SpieltageTU] SET " +
