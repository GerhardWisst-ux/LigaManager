    ...
    {       
        ...
        public async Task<VereinAUS> AddVerein(VereinAUS verein)
        {
            ...
            try
            {
                ...
                cmd.Connection = conn;
                cmd.CommandText = "INSERT INTO [VereinePL] (VereinNr,Vereinsname1,Vereinsname2,Stadion,Fassungsvermoegen,Erfolge,Gegruendet,Pokal,Liga1)" +
        ...
        public async Task<VereinAUS> DeleteVerein(int vereinId)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = conn;
            cmd.CommandText = "DELETE FROM [dbo].[VereinePL] Where Id= @Id";
        ...
        public async Task<VereinAUS> UpdateVerein(VereinAUS verein)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "UPDATE [dbo].[VereinePL] SET " +                        
