...
namespace LigaManagement.Api.Controllers
{
    ...
    [ApiController]
    public class SaisonenWMEMController : ControllerBase
    {
        private readonly ISaisonenCLRepository SaisonRepository;

        public SaisonenWMEMController(ISaisonenCLRepository SaisonRepository)
        {
        ...
        public async Task<ActionResult<Saison>> GetSaison(int Id)
        {
            try
            {
                var result = await SaisonRepository.GetSaisonEMWM(Id);
