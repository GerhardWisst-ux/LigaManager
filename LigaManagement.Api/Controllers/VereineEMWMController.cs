...
namespace LigaManagement.Api.Controllers
{
    ...
    [ApiController]
    public class VereineEMWMController : ControllerBase
    {
        private readonly IVereinRepository VereinRepository;

        public VereineEMWMController(IVereinRepository VereinRepository)
        {
        ...
        public async Task<ActionResult> GetVereine()
        {
            try
            {
                return Ok(await VereinRepository.GetVereineEMWM());
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<Verein>> GetVerein(int Id)
        {
            try
            {
                var result = await VereinRepository.GetVereinEMWM(Id);
