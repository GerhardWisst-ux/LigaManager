...
namespace LigaManagement.Api.Controllers
{
    ...
    [ApiController]
    public class VereineBEController : ControllerBase
    {
        private readonly IVereineBERepository VereinRepository;

        public VereineBEController(IVereineBERepository VereinRepository)
        {
