...
namespace LigaManagement.Api.Controllers
{
    ...
    [ApiController]
    public class VereineNLController : ControllerBase
    {
        private readonly IVereineNLRepository VereinRepository;

        public VereineNLController(IVereineNLRepository VereinRepository)
        {
