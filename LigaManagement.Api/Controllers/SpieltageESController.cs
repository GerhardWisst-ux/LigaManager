...
namespace LigaManagement.Api.Controllers
{
    ...
    [ApiController]
    public class SpieltageESController : ControllerBase
    {
        private readonly ISpieltageESRepository SpieltagPLRepository;

        public SpieltageESController(ISpieltageESRepository SpieltagPLRepository)
        {
